...
> âŸ¦ **layer** 6 (index) Â· **objective** the actualisation domain & its horizon â€” verify what is verifiable in the experiential domain; label the interpretation; mark the remainder that exceeds saying Â· **dominant-mode** empirical-actualisation (verifiable core) + ontological (interpretation) + unlabeled (horizon) Â· **status** three strata â€” core FOUNDED-in-domain, interpretation DEFENSIBLE-declared, horizon left **UNLABELED by design** Â· **cut** "I AM" as proven-fact â†’ held as earned recognition, not assertion Â· see [UNIVERSAL-PATTERN-SPACE.md](../UNIVERSAL-PATTERN-SPACE.md) Layer 6 âŸ§
